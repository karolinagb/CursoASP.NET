...
namespace SalesWebMVC.Data
{
    ...
    {
        /*Registrando uma dependência do SeedingService com o DBContext*/
        private SalesWebMVCContext _context;

        /*Agora vamos criar um construtor recebendo um objeto desse tipo para indicar que a injeção de
         dependência deve acontecer:*/
        ...
        public void Seed()
        {
            ...
            Seller s1 = new Seller(1, "Bob Brown", "bob@gmail.com", new DateTime(1998, 4, 12), 1000.0, d1);
